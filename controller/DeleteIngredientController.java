...
import ma.ac.esi.nutritrack.service.DeleteIngredientService;
...
public class DeleteIngredientController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        DeleteIngredientService ingredientService = new DeleteIngredientService();
        int ingredientId = Integer.parseInt(request.getParameter("ingredient"));
        boolean success = ingredientService.deleteIngredientFromMeal(ingredientId);
